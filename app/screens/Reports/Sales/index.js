...
var EventNote_1 = require("@material-ui/icons/EventNote");
...
var index = function (props) {
    ...
    return (React.createElement("div", { style: { width: 910, display: "flex" } },
        React.createElement("div", { style: {
            ...
            React.createElement(TableContainer_1.default, { component: core_1.Paper },
                ...
                React.createElement(core_1.Button, { style: { marginLeft: 10 }, variant: "outlined", startIcon: React.createElement(PictureAsPdf_1.default, null) }, "Save As Pdf"),
                React.createElement(Table_1.default, { stickyHeader: true, size: "small", "aria-label": "a dense table" },
                    React.createElement(TableHead_1.default, null,
                        React.createElement(TableRow_1.default, null,
                            React.createElement(TableCell_1.default, { align: "left" }, "Sr No"),
            ...
            React.createElement(core_1.Divider, { style: { marginTop: 20 } }),
            React.createElement(TableContainer_1.default, { style: { marginTop: 20 }, component: core_1.Paper },
                React.createElement(core_1.Typography, { style: { marginTop: 5, marginBottom: 5 } }, "Tax Invoice"),
                React.createElement(core_1.Button, { style: { marginLeft: 10 }, variant: "outlined", startIcon: React.createElement(PictureAsPdf_1.default, null) }, "Save As Pdf"),
                React.createElement(Table_1.default, { stickyHeader: true, size: "small", "aria-label": "a dense table" },
                    React.createElement(TableHead_1.default, null,
                        React.createElement(TableRow_1.default, null,
                    ...
                    React.createElement(TableBody_1.default, null, SalesList.data.map(function (row) { return (React.createElement(StyledTableRow, { key: row.SrNo },
                        ...
                        React.createElement(TableCell_1.default, { align: "right" },
                            React.createElement(core_1.Typography, null,
                                React.createElement(Currency, { locale: "en", quantity: row.totalTax, symbol: "K" }))))); }))))),
        React.createElement(core_1.Paper, { style: { width: "25%", padding: 5 } },
            React.createElement(core_1.FormControl, { style: { width: "100%" } },
                React.createElement(core_1.NativeSelect, { value: Dep, onChange: handleDepChange, inputProps: { "aria-label": "age" } }, Departments.map(function (list, index) { return (React.createElement("option", { value: list }, list.dep_name)); }))),
            React.createElement("div", { style: { padding: 10 } },
                React.createElement(core_1.Typography, { style: { color: "#ccc" } }, "Sales History")),
            ...
            React.createElement("div", { style: { paddingTop: 10, paddingBottom: 10 } },
                React.createElement(core_1.Typography, { style: { color: "#ccc" }, variant: "caption" }, "Month")),
            ...
            React.createElement(core_1.Divider, { style: { marginTop: 3, marginBottom: 5 } }),
            React.createElement("div", { style: { height: "60vh", overflow: "auto" } },
                React.createElement(core_1.Typography, null, "Pick Date"),
                React.createElement(ciqu_react_calendar_1.default, { onChange: onChange, value: selectedDate.value, allowClear: true, disabled: false, placeholder: "please input date", format: "DD-MM-YYYY", onOpenChange: onOpenChange, disabledDate: disabledDate }),
                React.createElement("div", { style: { padding: 15 } },
                    React.createElement(core_1.Divider, null)),
                React.createElement(core_1.List, { component: "nav", "aria-labelledby": "nested-list-subheader" },
                    React.createElement(core_1.ListItem, { selected: reportType === 2 ? true : false, onClick: function () {
                            setReportType(2);
                            handleGetSaleData({
                                date: month,
                                Datetype: "Month",
                        ...
                        React.createElement(core_1.ListItemIcon, null,
                            React.createElement(EventNote_1.default, null)),
                        React.createElement(core_1.ListItemText, { primary: "This Month Reports" })),
                    React.createElement(core_1.ListItem, { selected: reportType === 3 ? true : false, onClick: function () {
                            setReportType(1);
                            handleGetSaleData({
                                date: year,
                                Datetype: "Year",
                        ...
                        React.createElement(core_1.ListItemIcon, null,
                            React.createElement(EventNote_1.default, null)),
                        React.createElement(core_1.ListItemText, { primary: "This Year Reports" })))))));
};
