...
const GroupList = (props) => {
  ...
  React.useEffect(() => {
    ...
    appDb.HandlePrinterGroups(
      { _type: "getGrounpWithID", id: props.selected.idKey },
      (reciveCallback) => {
        console.log(reciveCallback);

        reciveCallback.map((list) => {
    ...
    appDb.HandlePrinterGroups({ _type: "getWithOutID" }, (reciveCallback) => {
      console.log(reciveCallback);
  ...
  const HandleSave = () => {
    appDb.HandlePrinterGroups(
      { _type: "edit", right, printerIP, id: props.selected.idKey },
      (callback) => {}
    );
  };
