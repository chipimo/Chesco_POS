...
var DepTable = function (props) {
    var _a = React.useState({
        columns: [
            { title: "Company Name", field: "dep_name" },
            { title: "Number", field: "phone" },
            { title: "Address", field: "shopNo" },
            { title: "City", field: "road" },
    ...
    React.useEffect(function () {
        dataBase_1.default.GetConfigfile(function (callback) {
            setState(__assign({}, state, { data: callback.config }));
        });
    }, []);
    return (React.createElement("div", { style: { height: "70vh", overflow: "auto" } },
        React.createElement(material_table_1.default, { icons: tableIcons, title: "Company", columns: state.columns, data: state.data, editable: {
                // onRowAdd: (newData) =>
                //   new Promise((resolve) => {
                //     if (!newData.dep_name) {
