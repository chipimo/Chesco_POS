                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, Promise.all(config.map(function (i) { return __awaiter(_this, void 0, void 0, function () {
                                        var match;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, bcrypt.compare(props.pin, i.pin)];
                                                case 1:
                                                    match = _a.sent();
                            ...
                            case 1:
                                asyncRes = _a.sent();
                                index = asyncRes.findIndex(function (x) { return x === true; });
                                if (index !== -1) {
                                    ...
                                    return [2 /*return*/, sendCallback({ isLoggedIn: false })];
                                return [3 /*break*/, 3];
                            case 2:
